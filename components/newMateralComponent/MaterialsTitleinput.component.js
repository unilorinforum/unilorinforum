...
class MaterialsTitleInputComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    const rawContent = window.localStorage.getItem('UF_MATERIAL_TITLE_INPUT');
    if (rawContent !== null) {
  ...
  render() {
    ...
    return (
      <div>
        <div className='text-2xl font-bold my-[10px] px-[3px]  '>
...
export default MaterialsTitleInputComponent;
